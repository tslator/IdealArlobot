...
#else
#define Left_Phase_Counter_INIT_COMPARE_VALUE      4294967295u
#define Left_Phase_Counter_INIT_INTERRUPTS_MASK ((uint8)((uint8)0u << Left_Phase_Counter_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
        ((uint8)((uint8)0u << Left_Phase_Counter_STATUS_CAPTURE_INT_EN_MASK_SHIFT)) | \
        ((uint8)((uint8)0u << Left_Phase_Counter_STATUS_CMP_INT_EN_MASK_SHIFT)) | \
