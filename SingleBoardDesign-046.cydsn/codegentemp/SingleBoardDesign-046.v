...
// TCPWM_P4_v2_0(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=1500, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=20000, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=TCPWM_P4_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Left_HB25_PWM, CY_INSTANCE_SHORT_NAME=Left_HB25_PWM, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP2, INSTANCE_NAME=Left_HB25_PWM, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=4294967295, CONTROL3=0, ControlRegRemoved=1, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=1, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=4294967294, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=true, InterruptOnTC=false, Period=4294967294, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=false, ReloadOnReset=true, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Counter_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Right_Phase_Counter, CY_INSTANCE_SHORT_NAME=Right_Phase_Counter, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP2, INSTANCE_NAME=Right_Phase_Counter, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=4294967295, CONTROL3=0, ControlRegRemoved=1, CyGetRegReplacementString=CY_GET_REG32, CySetRegReplacementString=CY_SET_REG32, EnableMode=1, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=4294967294, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=true, InterruptOnTC=false, Period=4294967294, RegDefReplacementString=reg32, RegSizeReplacementString=uint32, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=false, ReloadOnReset=true, Resolution=32, RunMode=0, UDB16=false, UDB24=false, UDB32=true, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC32, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Counter_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Left_Phase_Counter, CY_INSTANCE_SHORT_NAME=Left_Phase_Counter, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP2, INSTANCE_NAME=Left_Phase_Counter, )
...
module top ;
    ...
    // -- DFF Start --
    reg  cydff_2;
    always @(posedge Net_96 or posedge Net_101)
    begin
        if (Net_96)
        begin
            cydff_2 <= ~0;
    ...
    // -- AMuxHw Infrared_Analog_Mux start -- ***
    
    // -- AMuxHw Decoder Start--
    
    reg [15:0] Infrared_Analog_Mux_Decoder_one_hot;
    reg [3:0] Infrared_Analog_Mux_Decoder_old_id;
    wire  Infrared_Analog_Mux_Decoder_is_active;
    wire  Infrared_Analog_Mux_Decoder_enable;
    
    assign Infrared_Analog_Mux_Decoder_enable = 1'b1;
    
    genvar Infrared_Analog_Mux_Decoder_i;
    
    assign Infrared_Analog_Mux_Decoder_is_active = (Net_1809[3:0] == Infrared_Analog_Mux_Decoder_old_id) && Infrared_Analog_Mux_Decoder_enable;
    
    always @(posedge Net_1760)
    begin
        Infrared_Analog_Mux_Decoder_old_id = Net_1809[3:0];
    end
    
    generate
        for (Infrared_Analog_Mux_Decoder_i = 0; Infrared_Analog_Mux_Decoder_i < 16; Infrared_Analog_Mux_Decoder_i = Infrared_Analog_Mux_Decoder_i + 1 )
        begin : Infrared_Analog_Mux_OutBit
            always @(posedge Net_1760)
            begin
                Infrared_Analog_Mux_Decoder_one_hot[Infrared_Analog_Mux_Decoder_i] <= (Infrared_Analog_Mux_Decoder_old_id == Infrared_Analog_Mux_Decoder_i) && Infrared_Analog_Mux_Decoder_is_active;
            end
        end
    endgenerate
    ...
    cy_psoc3_amux_v1_0 #(
        ...
        .hw_ctrl_en(Infrared_Analog_Mux_Decoder_one_hot[15:0]),
        .vout(Net_1772)
        );
    
    // -- AMuxHw Infrared_Analog_Mux end -- ***

    ADC_SAR_SEQ_P4_v2_30_0 Infrared_ADC (
        .Vref(Net_3068),
        .sdone(Net_3069),
        .eoc(Net_3070),
        .aclk(1'b0),
	...
	wire [0:0] tmpOE__Infrared_Distance_Pin_15_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_15_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_15_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_15_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_15_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_15
		 (.oe(tmpOE__Infrared_Distance_Pin_15_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_15_net[0:0]}),
		  .analog({Net_1757}),
		  .io({tmpIO_0__Infrared_Distance_Pin_15_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_15_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_15_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_15_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Infrared_Distance_Pin_14_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_14_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_14_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_14_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_14_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_14
		 (.oe(tmpOE__Infrared_Distance_Pin_14_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_14_net[0:0]}),
		  .analog({Net_1756}),
		  .io({tmpIO_0__Infrared_Distance_Pin_14_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_14_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_14_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_14_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Infrared_Distance_Pin_13_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_13_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_13_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_13_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_13_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_13
		 (.oe(tmpOE__Infrared_Distance_Pin_13_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_13_net[0:0]}),
		  .analog({Net_1755}),
		  .io({tmpIO_0__Infrared_Distance_Pin_13_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_13_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_13_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_13_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Infrared_Distance_Pin_12_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_12_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_12_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_12_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_12_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_12
		 (.oe(tmpOE__Infrared_Distance_Pin_12_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_12_net[0:0]}),
		  .analog({Net_1754}),
		  .io({tmpIO_0__Infrared_Distance_Pin_12_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_12_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_12_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_12_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Infrared_Distance_Pin_11_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_11_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_11_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_11_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_11_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_11
		 (.oe(tmpOE__Infrared_Distance_Pin_11_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_11_net[0:0]}),
		  .analog({Net_1753}),
		  .io({tmpIO_0__Infrared_Distance_Pin_11_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_11_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_11_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_11_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Infrared_Distance_Pin_10_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_10_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_10_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_10_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_10_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_10
		 (.oe(tmpOE__Infrared_Distance_Pin_10_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_10_net[0:0]}),
		  .analog({Net_1752}),
		  .io({tmpIO_0__Infrared_Distance_Pin_10_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_10_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_10_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_10_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Infrared_Distance_Pin_9_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_9_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_9_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_9_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_9_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_9
		 (.oe(tmpOE__Infrared_Distance_Pin_9_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_9_net[0:0]}),
		  .analog({Net_1751}),
		  .io({tmpIO_0__Infrared_Distance_Pin_9_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_9_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_9_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_9_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Infrared_Distance_Pin_8_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_8_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_8_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_8_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_8_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_8
		 (.oe(tmpOE__Infrared_Distance_Pin_8_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_8_net[0:0]}),
		  .analog({Net_1750}),
		  .io({tmpIO_0__Infrared_Distance_Pin_8_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_8_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_8_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_8_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Infrared_Distance_Pin_7_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_7_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_7_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_7_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_7_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_7
		 (.oe(tmpOE__Infrared_Distance_Pin_7_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_7_net[0:0]}),
		  .analog({Net_1749}),
		  .io({tmpIO_0__Infrared_Distance_Pin_7_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_7_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Infrared_Distance_Pin_6_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_6_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_6_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_6_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_6_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_6
		 (.oe(tmpOE__Infrared_Distance_Pin_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_6_net[0:0]}),
		  .analog({Net_1748}),
		  .io({tmpIO_0__Infrared_Distance_Pin_6_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_6_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Infrared_Distance_Pin_5_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_5_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_5_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_5_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_5_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_5
		 (.oe(tmpOE__Infrared_Distance_Pin_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_5_net[0:0]}),
		  .analog({Net_1747}),
		  .io({tmpIO_0__Infrared_Distance_Pin_5_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_5_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Infrared_Distance_Pin_4_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_4_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_4_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_4_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_4_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_4
		 (.oe(tmpOE__Infrared_Distance_Pin_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_4_net[0:0]}),
		  .analog({Net_1746}),
		  .io({tmpIO_0__Infrared_Distance_Pin_4_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_4_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Infrared_Distance_Pin_3_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_3_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_3_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_3_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_3_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_3
		 (.oe(tmpOE__Infrared_Distance_Pin_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_3_net[0:0]}),
		  .analog({Net_1745}),
		  .io({tmpIO_0__Infrared_Distance_Pin_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_3_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	assign tmpOE__bufoe_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_95} : {Net_95};
    ...
    TCPWM_P4_v2_0_1 Right_HB25_PWM (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpOE__Infrared_Distance_Pin_2_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_2_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_2_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_2_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_2_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_2
		 (.oe(tmpOE__Infrared_Distance_Pin_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_2_net[0:0]}),
		  .analog({Net_1744}),
		  .io({tmpIO_0__Infrared_Distance_Pin_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_2_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Infrared_Distance_Pin_1_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_1_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_1_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_1_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_1
		 (.oe(tmpOE__Infrared_Distance_Pin_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_1_net[0:0]}),
		  .analog({Net_1743}),
		  .io({tmpIO_0__Infrared_Distance_Pin_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_1_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Infrared_Distance_Pin_0_net;
	wire [0:0] tmpFB_0__Infrared_Distance_Pin_0_net;
	wire [0:0] tmpIO_0__Infrared_Distance_Pin_0_net;
	wire [0:0] tmpINTERRUPT_0__Infrared_Distance_Pin_0_net;
	electrical [0:0] tmpSIOVREF__Infrared_Distance_Pin_0_net;
	...
	cy_psoc3_pins_v1_10
		...
		Infrared_Distance_Pin_0
		 (.oe(tmpOE__Infrared_Distance_Pin_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Infrared_Distance_Pin_0_net[0:0]}),
		  .analog({Net_1742}),
		  .io({tmpIO_0__Infrared_Distance_Pin_0_net[0:0]}),
		  .siovref(tmpSIOVREF__Infrared_Distance_Pin_0_net),
		  .interrupt({tmpINTERRUPT_0__Infrared_Distance_Pin_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Infrared_Distance_Pin_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__HCSR04_Trigger_15_net;
	wire [0:0] tmpFB_0__HCSR04_Trigger_15_net;
	wire [0:0] tmpIO_0__HCSR04_Trigger_15_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Trigger_15_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Trigger_15_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("40e6fa1a-092e-4d4c-be10-59fb16f63e88"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Trigger_15
		 (.oe(tmpOE__HCSR04_Trigger_15_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HCSR04_Trigger_15_net[0:0]}),
		  .io({tmpIO_0__HCSR04_Trigger_15_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Trigger_15_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Trigger_15_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Trigger_15_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Trigger_14_net;
	wire [0:0] tmpFB_0__HCSR04_Trigger_14_net;
	wire [0:0] tmpIO_0__HCSR04_Trigger_14_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Trigger_14_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Trigger_14_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("94cce30b-d4bc-4238-9b33-2c48290c5db5"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Trigger_14
		 (.oe(tmpOE__HCSR04_Trigger_14_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HCSR04_Trigger_14_net[0:0]}),
		  .io({tmpIO_0__HCSR04_Trigger_14_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Trigger_14_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Trigger_14_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Trigger_14_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Trigger_13_net;
	wire [0:0] tmpFB_0__HCSR04_Trigger_13_net;
	wire [0:0] tmpIO_0__HCSR04_Trigger_13_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Trigger_13_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Trigger_13_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("9fa9e13e-7ebe-42e8-a2f0-650cb79b0713"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Trigger_13
		 (.oe(tmpOE__HCSR04_Trigger_13_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HCSR04_Trigger_13_net[0:0]}),
		  .io({tmpIO_0__HCSR04_Trigger_13_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Trigger_13_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Trigger_13_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Trigger_13_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Trigger_12_net;
	wire [0:0] tmpFB_0__HCSR04_Trigger_12_net;
	wire [0:0] tmpIO_0__HCSR04_Trigger_12_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Trigger_12_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Trigger_12_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4e7a8d50-7ab1-43e6-b23f-24e0f29d69ad"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Trigger_12
		 (.oe(tmpOE__HCSR04_Trigger_12_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HCSR04_Trigger_12_net[0:0]}),
		  .io({tmpIO_0__HCSR04_Trigger_12_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Trigger_12_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Trigger_12_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Trigger_12_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Trigger_11_net;
	wire [0:0] tmpFB_0__HCSR04_Trigger_11_net;
	wire [0:0] tmpIO_0__HCSR04_Trigger_11_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Trigger_11_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Trigger_11_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("9eb7a655-17d2-46e6-a4ab-cc79a2e40e9e"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Trigger_11
		 (.oe(tmpOE__HCSR04_Trigger_11_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HCSR04_Trigger_11_net[0:0]}),
		  .io({tmpIO_0__HCSR04_Trigger_11_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Trigger_11_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Trigger_11_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Trigger_11_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Trigger_10_net;
	wire [0:0] tmpFB_0__HCSR04_Trigger_10_net;
	wire [0:0] tmpIO_0__HCSR04_Trigger_10_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Trigger_10_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Trigger_10_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("daa2c146-0b75-4a22-a3bd-aa78434a661b"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Trigger_10
		 (.oe(tmpOE__HCSR04_Trigger_10_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HCSR04_Trigger_10_net[0:0]}),
		  .io({tmpIO_0__HCSR04_Trigger_10_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Trigger_10_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Trigger_10_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Trigger_10_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Trigger_9_net;
	wire [0:0] tmpFB_0__HCSR04_Trigger_9_net;
	wire [0:0] tmpIO_0__HCSR04_Trigger_9_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Trigger_9_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Trigger_9_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("bb75164b-dc38-4729-a58f-23fb80113bea"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Trigger_9
		 (.oe(tmpOE__HCSR04_Trigger_9_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HCSR04_Trigger_9_net[0:0]}),
		  .io({tmpIO_0__HCSR04_Trigger_9_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Trigger_9_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Trigger_9_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Trigger_9_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Trigger_8_net;
	wire [0:0] tmpFB_0__HCSR04_Trigger_8_net;
	wire [0:0] tmpIO_0__HCSR04_Trigger_8_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Trigger_8_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Trigger_8_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("2b380cf5-8763-418b-912e-10104e4dfd30"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Trigger_8
		 (.oe(tmpOE__HCSR04_Trigger_8_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HCSR04_Trigger_8_net[0:0]}),
		  .io({tmpIO_0__HCSR04_Trigger_8_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Trigger_8_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Trigger_8_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Trigger_8_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Trigger_7_net;
	wire [0:0] tmpFB_0__HCSR04_Trigger_7_net;
	wire [0:0] tmpIO_0__HCSR04_Trigger_7_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Trigger_7_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Trigger_7_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("44645f7d-4c27-48b2-91ca-a5b4c30d274d"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Trigger_7
		 (.oe(tmpOE__HCSR04_Trigger_7_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HCSR04_Trigger_7_net[0:0]}),
		  .io({tmpIO_0__HCSR04_Trigger_7_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Trigger_7_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Trigger_7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Trigger_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Trigger_6_net;
	wire [0:0] tmpFB_0__HCSR04_Trigger_6_net;
	wire [0:0] tmpIO_0__HCSR04_Trigger_6_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Trigger_6_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Trigger_6_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("65c09472-d7df-4f49-85dd-ae61b31982f5"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Trigger_6
		 (.oe(tmpOE__HCSR04_Trigger_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HCSR04_Trigger_6_net[0:0]}),
		  .io({tmpIO_0__HCSR04_Trigger_6_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Trigger_6_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Trigger_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Trigger_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Trigger_5_net;
	wire [0:0] tmpFB_0__HCSR04_Trigger_5_net;
	wire [0:0] tmpIO_0__HCSR04_Trigger_5_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Trigger_5_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Trigger_5_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("29b3b7c2-9f68-431c-af2e-c69f05a459aa"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Trigger_5
		 (.oe(tmpOE__HCSR04_Trigger_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HCSR04_Trigger_5_net[0:0]}),
		  .io({tmpIO_0__HCSR04_Trigger_5_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Trigger_5_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Trigger_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Trigger_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Trigger_4_net;
	wire [0:0] tmpFB_0__HCSR04_Trigger_4_net;
	wire [0:0] tmpIO_0__HCSR04_Trigger_4_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Trigger_4_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Trigger_4_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("db3a8c58-82fa-4455-98df-752cfac34e61"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Trigger_4
		 (.oe(tmpOE__HCSR04_Trigger_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HCSR04_Trigger_4_net[0:0]}),
		  .io({tmpIO_0__HCSR04_Trigger_4_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Trigger_4_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Trigger_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Trigger_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam HCSR04_Control.NumOutputs = 4;

    // -- Mux start --
    if (1)
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_129 or Net_130 or Net_131 or Net_132 or Net_133 or Net_134 or Net_135 or Net_136 or Net_137 or Net_138 or Net_140 or Net_141 or Net_142 or Net_143 or Net_145 or Net_147 or Net_149)
        begin
            case (Net_149[3:0])
                4'b0000 :  tmp__mux_1_reg = Net_129;
                4'b0001 :  tmp__mux_1_reg = Net_130;
                4'b0010 :  tmp__mux_1_reg = Net_131;
                4'b0011 :  tmp__mux_1_reg = Net_132;
                4'b0100 :  tmp__mux_1_reg = Net_133;
                4'b0101 :  tmp__mux_1_reg = Net_134;
                4'b0110 :  tmp__mux_1_reg = Net_135;
                4'b0111 :  tmp__mux_1_reg = Net_136;
                4'b1000 :  tmp__mux_1_reg = Net_137;
                4'b1001 :  tmp__mux_1_reg = Net_138;
                4'b1010 :  tmp__mux_1_reg = Net_140;
                4'b1011 :  tmp__mux_1_reg = Net_141;
                4'b1100 :  tmp__mux_1_reg = Net_142;
                4'b1101 :  tmp__mux_1_reg = Net_143;
                4'b1110 :  tmp__mux_1_reg = Net_145;
                4'b1111 :  tmp__mux_1_reg = Net_147;
            endcase
        end
        assign Net_109 = tmp__mux_1_reg;
    end
    // -- Mux end --
    ...
    assign Net_3294 = 1'h1;

	wire [0:0] tmpOE__HCSR04_Echo_15_net;
	wire [0:0] tmpIO_0__HCSR04_Echo_15_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Echo_15_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Echo_15_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ca3f3a0a-9e81-4cba-9e6b-1ef5252f87e9"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Echo_15
		 (.oe(tmpOE__HCSR04_Echo_15_net),
		  .y({1'b0}),
		  .fb({Net_147}),
		  .io({tmpIO_0__HCSR04_Echo_15_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Echo_15_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Echo_15_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Echo_15_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SCB_P4_v3_10_4 EZI2C_1 (
        .interrupt(Net_3300),
        .clock(1'b0),
        .rx_tr_out(Net_3302),
        .tx_tr_out(Net_3303));
    ...
    Counter_v3_0_5 Right_Phase_Counter (
        .reset(1'b0),
        .tc(Net_3292),
        .comp(Net_3293),
        .clock(Net_75),
        ...
        .up_ndown(Net_3156),
        .count(Net_3157));
    defparam Right_Phase_Counter.CaptureMode = 0;
    defparam Right_Phase_Counter.ClockMode = 1;
    defparam Right_Phase_Counter.CompareMode = 1;
    defparam Right_Phase_Counter.CompareStatusEdgeSense = 1;
    defparam Right_Phase_Counter.EnableMode = 1;
    defparam Right_Phase_Counter.ReloadOnCapture = 0;
    defparam Right_Phase_Counter.ReloadOnCompare = 0;
    defparam Right_Phase_Counter.ReloadOnOverUnder = 0;
    defparam Right_Phase_Counter.ReloadOnReset = 1;
    defparam Right_Phase_Counter.Resolution = 32;
    defparam Right_Phase_Counter.RunMode = 0;
    defparam Right_Phase_Counter.UseInterrupt = 1;

    // -- LUT Right_Decode_Lookup start --
    if (1)
    begin : Right_Decode_Lookup
        reg [3:0] tmp__Right_Decode_Lookup_reg;
        wire [3:0] tmp__Right_Decode_Lookup_ins;
        assign tmp__Right_Decode_Lookup_ins = {Net_3155,Net_3153,Net_3193,Net_3194};
        always @(posedge Net_75)
        begin
            case (tmp__Right_Decode_Lookup_ins)
                4'b0000 :  tmp__Right_Decode_Lookup_reg = 4'b0000;
                4'b0001 :  tmp__Right_Decode_Lookup_reg = 4'b1001;
                4'b0010 :  tmp__Right_Decode_Lookup_reg = 4'b1110;
                4'b0011 :  tmp__Right_Decode_Lookup_reg = 4'b0011;
                4'b0100 :  tmp__Right_Decode_Lookup_reg = 4'b1100;
                4'b0101 :  tmp__Right_Decode_Lookup_reg = 4'b0001;
                4'b0110 :  tmp__Right_Decode_Lookup_reg = 4'b0010;
                4'b0111 :  tmp__Right_Decode_Lookup_reg = 4'b1011;
                4'b1000 :  tmp__Right_Decode_Lookup_reg = 4'b1000;
                4'b1001 :  tmp__Right_Decode_Lookup_reg = 4'b0001;
                4'b1010 :  tmp__Right_Decode_Lookup_reg = 4'b0010;
                4'b1011 :  tmp__Right_Decode_Lookup_reg = 4'b1111;
                4'b1100 :  tmp__Right_Decode_Lookup_reg = 4'b0000;
                4'b1101 :  tmp__Right_Decode_Lookup_reg = 4'b1101;
                4'b1110 :  tmp__Right_Decode_Lookup_reg = 4'b1010;
                4'b1111 :  tmp__Right_Decode_Lookup_reg = 4'b0011;
            endcase
        end
        assign {Net_3157,Net_3156,Net_3155,Net_3153} = tmp__Right_Decode_Lookup_reg;
    end
    // -- LUT Right_Decode_Lookup end --
	...
	wire [0:0] tmpOE__HCSR04_Echo_14_net;
	wire [0:0] tmpIO_0__HCSR04_Echo_14_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Echo_14_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Echo_14_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8ea2ebf1-9726-4905-b44a-e3cd21d5032c"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Echo_14
		 (.oe(tmpOE__HCSR04_Echo_14_net),
		  .y({1'b0}),
		  .fb({Net_145}),
		  .io({tmpIO_0__HCSR04_Echo_14_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Echo_14_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Echo_14_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Echo_14_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Echo_13_net;
	wire [0:0] tmpIO_0__HCSR04_Echo_13_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Echo_13_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Echo_13_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("46f47035-54cf-48dd-beff-bdf65c97a387"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Echo_13
		 (.oe(tmpOE__HCSR04_Echo_13_net),
		  .y({1'b0}),
		  .fb({Net_143}),
		  .io({tmpIO_0__HCSR04_Echo_13_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Echo_13_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Echo_13_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Echo_13_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Counter_v3_0_6 Left_Phase_Counter (
        .reset(1'b0),
        .tc(Net_3279),
        .comp(Net_3280),
        .clock(Net_75),
        ...
        .up_ndown(Net_112),
        .count(Net_64));
    defparam Left_Phase_Counter.CaptureMode = 0;
    defparam Left_Phase_Counter.ClockMode = 1;
    defparam Left_Phase_Counter.CompareMode = 1;
    defparam Left_Phase_Counter.CompareStatusEdgeSense = 1;
    defparam Left_Phase_Counter.EnableMode = 1;
    defparam Left_Phase_Counter.ReloadOnCapture = 0;
    defparam Left_Phase_Counter.ReloadOnCompare = 0;
    defparam Left_Phase_Counter.ReloadOnOverUnder = 0;
    defparam Left_Phase_Counter.ReloadOnReset = 1;
    defparam Left_Phase_Counter.Resolution = 32;
    defparam Left_Phase_Counter.RunMode = 0;
    defparam Left_Phase_Counter.UseInterrupt = 1;

    // -- LUT Left_Decode_Lookup start --
    if (1)
    begin : Left_Decode_Lookup
        reg [3:0] tmp__Left_Decode_Lookup_reg;
        wire [3:0] tmp__Left_Decode_Lookup_ins;
        assign tmp__Left_Decode_Lookup_ins = {Net_69,Net_70,Net_3174,Net_3173};
        always @(posedge Net_75)
        begin
            case (tmp__Left_Decode_Lookup_ins)
                4'b0000 :  tmp__Left_Decode_Lookup_reg = 4'b0000;
                4'b0001 :  tmp__Left_Decode_Lookup_reg = 4'b1001;
                4'b0010 :  tmp__Left_Decode_Lookup_reg = 4'b1110;
                4'b0011 :  tmp__Left_Decode_Lookup_reg = 4'b0011;
                4'b0100 :  tmp__Left_Decode_Lookup_reg = 4'b1100;
                4'b0101 :  tmp__Left_Decode_Lookup_reg = 4'b0001;
                4'b0110 :  tmp__Left_Decode_Lookup_reg = 4'b0010;
                4'b0111 :  tmp__Left_Decode_Lookup_reg = 4'b1011;
                4'b1000 :  tmp__Left_Decode_Lookup_reg = 4'b1000;
                4'b1001 :  tmp__Left_Decode_Lookup_reg = 4'b0001;
                4'b1010 :  tmp__Left_Decode_Lookup_reg = 4'b0010;
                4'b1011 :  tmp__Left_Decode_Lookup_reg = 4'b1111;
                4'b1100 :  tmp__Left_Decode_Lookup_reg = 4'b0000;
                4'b1101 :  tmp__Left_Decode_Lookup_reg = 4'b1101;
                4'b1110 :  tmp__Left_Decode_Lookup_reg = 4'b1010;
                4'b1111 :  tmp__Left_Decode_Lookup_reg = 4'b0011;
            endcase
        end
        assign {Net_64,Net_112,Net_69,Net_70} = tmp__Left_Decode_Lookup_reg;
    end
    // -- LUT Left_Decode_Lookup end --
	...
	wire [0:0] tmpOE__HCSR04_Echo_12_net;
	wire [0:0] tmpIO_0__HCSR04_Echo_12_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Echo_12_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Echo_12_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("463e1766-e36b-4b00-886b-e05706aeed9b"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Echo_12
		 (.oe(tmpOE__HCSR04_Echo_12_net),
		  .y({1'b0}),
		  .fb({Net_142}),
		  .io({tmpIO_0__HCSR04_Echo_12_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Echo_12_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Echo_12_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Echo_12_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Echo_11_net;
	wire [0:0] tmpIO_0__HCSR04_Echo_11_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Echo_11_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Echo_11_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d09decf1-4308-4711-88fc-1efd006bcf74"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Echo_11
		 (.oe(tmpOE__HCSR04_Echo_11_net),
		  .y({1'b0}),
		  .fb({Net_141}),
		  .io({tmpIO_0__HCSR04_Echo_11_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Echo_11_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Echo_11_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Echo_11_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Echo_10_net;
	wire [0:0] tmpIO_0__HCSR04_Echo_10_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Echo_10_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Echo_10_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("6527c387-bff4-46c4-94e8-a8a1d09ba100"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Echo_10
		 (.oe(tmpOE__HCSR04_Echo_10_net),
		  .y({1'b0}),
		  .fb({Net_140}),
		  .io({tmpIO_0__HCSR04_Echo_10_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Echo_10_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Echo_10_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Echo_10_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Echo_9_net;
	wire [0:0] tmpIO_0__HCSR04_Echo_9_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Echo_9_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Echo_9_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("5ed8a63f-b714-466e-8478-008b4751564a"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Echo_9
		 (.oe(tmpOE__HCSR04_Echo_9_net),
		  .y({1'b0}),
		  .fb({Net_138}),
		  .io({tmpIO_0__HCSR04_Echo_9_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Echo_9_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Echo_9_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Echo_9_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Echo_8_net;
	wire [0:0] tmpIO_0__HCSR04_Echo_8_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Echo_8_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Echo_8_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1846302f-954e-47f2-b149-777c370bd83d"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Echo_8
		 (.oe(tmpOE__HCSR04_Echo_8_net),
		  .y({1'b0}),
		  .fb({Net_137}),
		  .io({tmpIO_0__HCSR04_Echo_8_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Echo_8_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Echo_8_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Echo_8_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Echo_7_net;
	wire [0:0] tmpIO_0__HCSR04_Echo_7_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Echo_7_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Echo_7_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("a06fbc30-f5cf-4330-af3b-7470cdaac4ec"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Echo_7
		 (.oe(tmpOE__HCSR04_Echo_7_net),
		  .y({1'b0}),
		  .fb({Net_136}),
		  .io({tmpIO_0__HCSR04_Echo_7_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Echo_7_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Echo_7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Echo_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Echo_6_net;
	wire [0:0] tmpIO_0__HCSR04_Echo_6_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Echo_6_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Echo_6_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("777d4b8e-ac42-470d-bd85-0be32ff8670c"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Echo_6
		 (.oe(tmpOE__HCSR04_Echo_6_net),
		  .y({1'b0}),
		  .fb({Net_135}),
		  .io({tmpIO_0__HCSR04_Echo_6_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Echo_6_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Echo_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Echo_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Echo_5_net;
	wire [0:0] tmpIO_0__HCSR04_Echo_5_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Echo_5_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Echo_5_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("b6a17cc3-55c8-4513-859c-a3cfda6e1b01"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Echo_5
		 (.oe(tmpOE__HCSR04_Echo_5_net),
		  .y({1'b0}),
		  .fb({Net_134}),
		  .io({tmpIO_0__HCSR04_Echo_5_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Echo_5_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Echo_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Echo_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HCSR04_Echo_4_net;
	wire [0:0] tmpIO_0__HCSR04_Echo_4_net;
	wire [0:0] tmpINTERRUPT_0__HCSR04_Echo_4_net;
	electrical [0:0] tmpSIOVREF__HCSR04_Echo_4_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("2ef10df9-a843-4170-aa0d-9501a21c2155"),
		  ...
		  .input_buffer_sel(2'b00))
		HCSR04_Echo_4
		 (.oe(tmpOE__HCSR04_Echo_4_net),
		  .y({1'b0}),
		  .fb({Net_133}),
		  .io({tmpIO_0__HCSR04_Echo_4_net[0:0]}),
		  .siovref(tmpSIOVREF__HCSR04_Echo_4_net),
		  .interrupt({tmpINTERRUPT_0__HCSR04_Echo_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HCSR04_Echo_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
